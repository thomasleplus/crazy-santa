...
function start() {
  ...
  if (npart === 0) {
    ...
    output +=
      "Before we start, write a number for each participant on pieces of paper and ask everyone to blindly draw one paper from a hat. When you are ready, tell me how many people are participating? ";
    ...
    output +=
      "Finally participant #" +
      npart +
      " can swap gift with participant #1. That's all folks! ";
    ...
    if (cswap === 0) {
      ...
      output +=
        "Does participant #" +
        cswap +
        " want to swap gift with participant #" +
        cpart +
        "? ";

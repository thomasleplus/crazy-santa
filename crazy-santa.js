...
function start() {
  ...
  if (npart == null) {
    ...
    output += 'Before we start, each participant should be assigned a number randomly. You can for example write each number on a piece of paper and have the participants draw the papers from a hat.<br/>When you are ready, tell me how many people are participating? ';
